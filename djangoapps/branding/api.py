...
def _footer_copyright():
    ...
    """
    org_name = (
        "Funix" if settings.FEATURES.get('IS_EDX_DOMAIN', False)
    ...
    #    u"Funix, Open Funix and the Funix and Open Funix logos are registered trademarks "
    #    u"or trademarks of Funix Inc."
